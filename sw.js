...
const KEEP = [
  ...
  "./game/binjgb.js",
  "./game/binjgb.wasm",
  /* ★ GBA 코어(mgba.js / mgba.wasm)는 여기에 안 적습니다 — 아직 파일이 없습니다.
       적어두면 "sw.js 가 저장할 파일이 전부 있는가" 검사가 걸립니다.
       파일을 넣으면 이 목록에 두 줄을 더하세요. 안 더해도 동작은 합니다 —
       아래 fetch 처리가 처음 쓸 때 알아서 저장합니다. 미리 받아두느냐 차이뿐입니다. */
];
